        ...
        if (pakiet.equalsIgnoreCase(pakiet_A)) {
            if (liczbaMinut > iloscDarmowychMinut_A) {
                ...
                if (liczbaMinut > iloscDarmowychMinut_B) {
                    int roznicaMinutB = liczbaMinut - iloscDarmowychMinut_B;
                    double kwotaZaMinutyB = roznicaMinutB * cenaPoPrzekroczeniuLimitu_B;
                    double kwotaDoZaplatyB = kwotaZaMinutyB + cenaPakietu_B;
                    double oszczednoscPakietB = kwotaDoZaplaty - kwotaDoZaplatyB;
                    System.out.println("Wybierając pakiet B zaoszczędziłbyś: " + oszczednoscPakietB);

                } else if (kwotaDoZaplaty > cenaPakietu_B) {
                    double oszczednoscPakietB = kwotaDoZaplaty - cenaPakietu_B;
                    double oszczednoscPakietC = kwotaDoZaplaty - cenaPakietu_C;
                    System.out.println("Wybierając pakiet B zaoszczędziłbyś: " + oszczednoscPakietB);
                    System.out.println("Wybierając pakiet C zaoszczędziłbyś: " + oszczednoscPakietC);
                }
            } else {
                System.out.println("RACHUNEK ZA PAKIET A: \nKwota do zapłaty: "
                        + cenaPakietu_A + " zł");
            ...
            if (liczbaMinut > iloscDarmowychMinut_A) {
                int roznicaMinutA = liczbaMinut - iloscDarmowychMinut_A;
                double kwotaZaMinutyA = roznicaMinutA * cenaPoPrzekroczeniuLimitu_A;
                double kwotaDoZaplatyA = kwotaZaMinutyA + cenaPakietu_A;
                double oszczednoscPakietA = cenaPakietu_B - kwotaDoZaplatyA;
                System.out.println("Wybierając pakiet A zaoszczędziłbyś: " + oszczednoscPakietA);
            } else if (liczbaMinut < iloscDarmowychMinut_A) {
                double oszczednoscPakietA = cenaPakietu_B - cenaPakietu_A;
                System.out.println("Wybierając pakiet A zaoszczędziłbyś: " + oszczednoscPakietA);

            } else if (kwotaDoZaplaty > cenaPakietu_C) {
                double oszczednoscPakietC = kwotaDoZaplaty - cenaPakietu_C;
                System.out.println("Wybierając pakiet C zaoszczędziłbyś: " + oszczednoscPakietC);
            }
            ...
            if (liczbaMinut < iloscDarmowychMinut_A) {
                double oszczednoscPakietA = cenaPakietu_C - cenaPakietu_A;
                System.out.println("Wybierając pakiet A zaoszczędziłbyś: " + oszczednoscPakietA);
            } else if (liczbaMinut < iloscDarmowychMinut_B) {
                double oszczednoscPakietB = cenaPakietu_C - cenaPakietu_B;
                System.out.println("Wybierając pakiet B zaoszczędziłbyś: " + oszczednoscPakietB);
            }
        } else {
